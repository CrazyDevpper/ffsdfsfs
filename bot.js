...
client.user.setGame(`!help`,"https://www.twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ●
** 
!credit = لمعرفة عدد الكريدت الي معك
!trans = لتحويل الكريدت لشخص
!daily = لاخذ الراتب اليومي 
!mute = لإعطاء شخص ميوت
!unmute = لفك الميوت عن شخص
!ban = لإعطاء باند لشخص 
!kick = لإعطاء شخص كيك
!avatar = لرؤية صورتك
!role = لاعطاء رتبة لشخص
!roleremove = لسحب الرتبة من شخص
● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ●
